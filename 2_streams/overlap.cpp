...
int main() {
  ...
  hipHostMalloc(&h_x,  ds*sizeof(ft), hipHostMallocDefault);
  hipHostMalloc(&h_y,  ds*sizeof(ft), hipHostMallocDefault);
  hipHostMalloc(&h_y1, ds*sizeof(ft), hipHostMallocDefault);
