...
By default, all GPU code run in the same stream i.e. stream 0. (TODO: fact check
...
Something to keep in mind is that since the pinned memory is locked and cannot be paged out, 
